...
interface CheckoutSignupFormContentProps {
  onSuccess: () => void;
...
export function CheckoutSignupFormContent({ onSuccess, onSwitchToLogin, planName, planPrice }: CheckoutSignupFormContentProps) {
  ...
  const handleGoogleAuth = async () => {
    logInfo("Starting Google OAuth from checkout signup", "auth");
