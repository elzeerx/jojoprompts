...
export default function TermsOfServicePage() {
  return (
    <div className="container max-w-4xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-8 text-dark-base">Terms of Service</h1>
      
      <div className="prose prose-slate max-w-none">
        <p className="mb-4">Last updated: May 20, 2025</p>
        
        <h2 className="text-xl font-semibold mt-8 mb-4 text-dark-base">1. Agreement to Terms</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 text-dark-base">2. Intellectual Property Rights</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 text-dark-base">3. User Representations</h2>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 text-dark-base">4. Purchases and Payment</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 text-dark-base">5. Prohibited Activities</h2>
        <p>You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>
        
        <h2 className="text-xl font-semibold mt-8 mb-4 text-dark-base">6. Term and Termination</h2>
        <p>
          These Terms of Service shall remain in full force and effect while you use the Site. Without limiting any other provision of these terms of service, we reserve the right to, in our sole discretion and without notice or liability, deny access to and use of the site to any person for any reason or for no reason.
        </p>
        
        <h2 className="text-xl font-semibold mt-8 mb-4 text-dark-base">7. Modifications and Interruptions</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-4 text-dark-base">8. Contact Us</h2>
        <p>
