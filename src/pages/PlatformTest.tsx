        ...
        <Card className="border-4 border-primary">
          <CardHeader className="bg-primary/5">
            <div className="flex items-center gap-2">
              <Badge variant="default" className="text-xs">⭐ MAIN DEMO - Phase 3.2</Badge>
              <CardTitle>Prompt Creation Wizard</CardTitle>
            </div>
            <CardDescription>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    >
                      <LucideIcons.Layers className="h-5 w-5 mr-2" />
