    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #c49d68 0%, #b8935a 100%); color: white; padding: 30px; border-radius: 8px 8px 0 0; text-align: center;">
          <img src="https://fxkqgjakbyrxkmevkglv.supabase.co/storage/v1/object/public/default-prompt-images/jojo-prompts-logo.png" alt="JoJo Prompts" style="max-height: 60px; margin-bottom: 15px;" />
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: #dc3545; color: white; padding: 20px; border-radius: 8px 8px 0 0; text-align: center;">
          <img src="https://fxkqgjakbyrxkmevkglv.supabase.co/storage/v1/object/public/default-prompt-images/jojo-prompts-logo.png" alt="JoJo Prompts" style="max-height: 50px; margin-bottom: 10px; filter: brightness(0) invert(1);" />
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: #dc3545; color: white; padding: 30px; border-radius: 8px 8px 0 0; text-align: center;">
          <img src="https://fxkqgjakbyrxkmevkglv.supabase.co/storage/v1/object/public/default-prompt-images/jojo-prompts-logo.png" alt="JoJo Prompts" style="max-height: 60px; margin-bottom: 15px; filter: brightness(0) invert(1);" />
