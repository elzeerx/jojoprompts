...
import { Platform, PlatformWithFields, PlatformField, PromptTemplate } from '@/types/platform';
...
export function usePlatformWithFields(platformId: string) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...platform,
        fields: fields as PlatformField[],
      } as PlatformWithFields;
    },
    enabled: !!platformId,
  });
}
