...
BEGIN
  ...
  SELECT EXISTS (
    ...
    JOIN pg_catalog.pg_namespace n ON n.oid = c.relnamespace
    JOIN pg_catalog.pg_attribute a1 ON a1.attrelid = c.oid AND a1.attnum = con.conkey[1]
    JOIN pg_catalog.pg_attribute a2 ON a2.attrelid = c.oid AND a2.attnum = con.conkey[2]
