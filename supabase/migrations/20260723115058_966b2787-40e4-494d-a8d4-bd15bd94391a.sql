  ...
  IF NOT p_dry_run THEN
    ...
    VALUES (
      ...
      jsonb_build_object(
        ...
        'rollback_hint', 'Delete public.resources where id = ANY(inserted_resource_ids); dependent version/compat/product rows are keyed by resource_id and SKU JOJO-LEGACY-*.'
      )
    );
  END IF;
