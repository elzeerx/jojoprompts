...
REVOKE ALL ON FUNCTION public.v2_admin_list_package_scan_queue(text[], text, integer, integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.v2_admin_list_package_scan_queue(text[], text, integer, integer) FROM anon;
REVOKE ALL ON FUNCTION public.v2_admin_list_package_scan_queue(text[], text, integer, integer) FROM service_role;
