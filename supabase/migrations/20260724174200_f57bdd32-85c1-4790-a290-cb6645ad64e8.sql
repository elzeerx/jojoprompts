-- Phase 6E1: Admin Package Scans Queue & History — read-only RPC
...
REVOKE ALL ON FUNCTION public.v2_admin_list_package_scan_queue(text[], text, int, int)
  FROM PUBLIC, anon, service_role;
GRANT EXECUTE ON FUNCTION public.v2_admin_list_package_scan_queue(text[], text, int, int)
  TO authenticated;